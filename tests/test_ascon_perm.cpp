...
TEST(AsconPermutation, AsconPermWithAsconHashIV)
{
  constexpr bool res = apply_permutation(ascon_hash::IV).reveal() ==
                       std::array<uint64_t, 5>{ 0xee9398aadb67f03dul, 0x8bb21831c60f1002ul, 0xb48a92db98d5da62ul, 0x43189921b8f8e3e8ul, 0x348fa5c9d525e140ul };
...
TEST(AsconPermutation, AsconPermWithAsconHashAIV)
{
  constexpr bool res = apply_permutation(ascon_hasha::IV).reveal() ==
                       std::array<uint64_t, 5>{ 0x01470194fc6528a6, 0x738ec38ac0adffa7, 0x2ec8e3296c76384c, 0xd6f6a54d7f52377d, 0xa13c42a223be8d87 };
...
TEST(AsconPermutation, AsconPermWithAsconXofIV)
{
  constexpr bool res = apply_permutation(ascon_xof::IV).reveal() ==
                       std::array<uint64_t, 5>{ 0xb57e273b814cd416, 0x2b51042562ae2420, 0x66a3a7768ddf2218, 0x5aad0a7a8153650c, 0x4f3e0e32539493b6 };
...
TEST(AsconPermutation, AsconPermWithAsconXofAIV)
{
  constexpr bool res = apply_permutation(ascon_xofa::IV).reveal() ==
                       std::array<uint64_t, 5>{ 0x44906568b77b9832, 0xcd8d6cae53455532, 0xf7b5212756422129, 0x246885e1de0d225b, 0xa8cb5ce33449973f };
